...
public class PostsApiControllerTest {
	...
	public void Posts_수정된다() throws Exception {
		...
		// when
		// ResponseEntity<Long> responseEntity = restTemplate.exchange("/api/v1/posts/"+updateId, HttpMethod.PUT, requestEntity, Long.class);
